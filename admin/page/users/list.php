<?php
require_once DOCUMENT_ROOT . '/admin/entities/User.php';
                    ...
                    <?php if (isset($list)) { ?>
                        <?php for ($i = 0; $i < count($list); $i++) { ?>
                            <tr>
                                ...
                                <?php if($list[$i]->getPermission() == 0){ ?>
                                    <td>
                                        <a href="/admin/?act=user&type=delete&id=<?php echo $list[$i]->getId(); ?>" class="btn btn-danger btn-xs delete-product" onclick="return confirm_click();"><i
