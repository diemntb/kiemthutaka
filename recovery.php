...
//    $old_pwd = $_POST['txtMKCu'];
    ...
    $n = User::changePasswordRecovery($username, $new_pwd, $idUser);
                        ...
                        <form action="" method="post" id="frm">
                            ...
                            <table id="tableDangKy" cellpadding="2" cellspacing="0">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Tên đăng nhập:</td>
                                    <td><strong><?php echo $list->getUsername(); ?></strong>
                                        <input type="hidden" name="txtUsername" value="<?php echo $list->getUsername(); ?>"/>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>Mật khẩu mới:</td>
                                    <td><input required="true" type="password" id="txtMKMoi" name="txtMKMoi" /></td>
                                    <td><label style="color: red; font-weight: bold;" id="newPassword"> Mật khẩu không giống nhau</label></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Nhập lại:</td>
                                    <td><input required="true" type="password" id="txtNLMK" name="txtNLMK" /></td>
                                    
                                    <td><label style="color: red; font-weight: bold;" id="newPasswordRepeat"> Mật khẩu không giống nhau</label></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>Họ tên:</td>
                                    <td>
                                        <input disabled="true" type="text" id="txtHoTen" name="txtHoTen" value="<?php echo $list->getName(); ?>" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Email:</td>
                                    <td>
                                        <input disabled="true" type="text" id="txtEmail" name="txtEmail" value="<?php echo $list->getEmail(); ?>" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Ngày sinh:</td>
                                    <td>
                                        <input disabled="true" type="text" id="txtNgaySinh" name="txtNgaySinh" value="<?php echo $list->getDob(); ?>" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td><input disabled="true" name="btnCapNhat" type="submit" class="blueButton" id="btnCapNhat" value="Cập nhật" /></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
...
<script type="text/javascript">
    ...
    $('#txtMKMoi').on("input", function(e) {
        let password = $('#txtMKMoi').val();
        let passwordRepeat = $('#txtNLMK').val();
