<?php
    ...
    $listProductChart = Products::loadProductsAll();
    $listUser = User::loadUserName();
    $listCat = categories::loadAll();

    define("SERVER1", "localhost");
    define("DB1", "db_taka");
    define("UID1", "user_cms");
    define("PWD1", "MNyLxQBetNFNedrf");
    ...
    // $qqq = "UPDATE products SET Quantity = 1500";
    // execQuery($qqq);
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="index.php?act=orders&type=list" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <div class="small-box bg-green">
                    ...
                    <a href="index.php?act=products&type=index" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <div class="small-box bg-yellow">
                    ...
                    <a href="index.php?act=user&type=list" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <div class="small-box bg-red">
                    ...
                    <a href="index.php?act=cate_products&type=index" class="small-box-footer">Xem thêm <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
        <script>
            function drawGraph(){
                var data = <?php echo json_encode($listProductChart, JSON_UNESCAPED_UNICODE ); ?> ;
                console.log(data[5])
