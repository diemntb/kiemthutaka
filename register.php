                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="main_body">
                        <form id="fr" name="fr" method="post" action="" onsubmit="return KTraDK();">
                            ...
                            <table width="562" cellpadding="2" cellspacing="0" id="tableDangKy"
                                   style="margin-left: 310px;">
                               
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Tên đăng nhập:</td>
                                    <td><input required="true" type="text" name="txtTenDN" id="txtTenDN"/></td>
                                    <td style="text-align: center; color: #FF0000;"> *</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Mật khẩu:</td>
                                    <td><input required="true" type="password" name="txtMK" id="txtMK"/></td>
                                    <td style="text-align: center; color: #FF0000;">*</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Nhập lại:</td>
                                    <td><input required="true" type="password" name="txtNLMK" id="txtNLMK"/></td>
                                    <td style="text-align: center; color: #FF0000;">*</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Họ tên:</td>
                                    <td><input required="true" type="text" name="txtHoTen" id="txtHoTen"/></td>
                                    <td style="text-align: center">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Email:</td>
                                    <td><input required="true" type="text" name="txtEmail" id="txtEmail"/></td>
                                    <td style="text-align: center; color: #FF0000;">*</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>Ngày sinh:</td>
                                    <td>
                                        <input required="true" autocomplete="off" type="text" name="txtNgaySinh" id="txtNgaySinh"/>
                                    </td>
                                    <td style="text-align: center">&nbsp;</td>
                                </tr>
                                <tr>
