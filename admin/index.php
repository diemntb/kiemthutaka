...
<head>
    ...
    <link rel="icon" href="http://taka.giaiphapvang.com.vn/img/tree.ico" type="image/x-icon" />
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        ...
                        <div class="pull-right"> 
                            <a href="logout.php" class="dropdown-toggle">Đăng xuất</a>
                        </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin?act=products&type=index"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
                        <li><a href="/admin?act=products&type=add"><i class="fa fa-circle-o"></i> Thêm</a></li>
                        <li><a href="/admin?act=cate_products&type=index"><i class="fa fa-circle-o"></i> Danh mục</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin?act=user&type=list"><i class="fa fa-circle-o"></i> Danh sách users</a></li>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin?act=orderwebix&type=list"><i class="fa fa-circle-o"></i> Danh sách</a></li>
                        </li>
                    </ul>
                </li>
            </ul>
